...
public class TestiniumBrowserExec {
    ...
    private static Logger logger = LogManager.getLogger(TestiniumBrowserExec.class);
    ...
    public static WebDriver TestiniumExec(String key) {
        ...
        switch (browser.toLowerCase(Locale.ENGLISH)){
            ...
            case "firefox" :
                ...
                break;
            case "edge" :
                driver = getEdgeDriver(capabilities,testiniumHubUrl);
                break;
            case "safari" :
                driver = getSafariDriver(capabilities,testiniumHubUrl);
                break;
            default:
    ...
    private static WebDriver getEdgeDriver(DesiredCapabilities capabilities, String testiniumHubUrl){
        ...
        /** Map<String, Object> map = new HashMap<>();
         List<String> args = Arrays.asList(//"--start-fullscreen"
         //"--start-maximized",
         "disable-translate"
